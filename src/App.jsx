...
function App() {
  ...
  return (
    <div className="bg-black text-white min-h-dvh flex flex-col justify-center">
      <div className="max-w-sm container flex flex-col justify-center min-h-dvh mx-auto overflow-hidden">
        {showIntro ? (
          <Intro />
        ) : isLogin ? (
          <Thumbnail />
